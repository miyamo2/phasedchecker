...
func TestCheckDiagnostics(t *testing.T) {
	...
	t.Run(
		"match removes last expectation and deletes key", func(t *testing.T) {
			t.Parallel()
			mt := &mockT{}
	...
	t.Run(
		"match removes one of multiple expectations", func(t *testing.T) {
			t.Parallel()
			mt := &mockT{}
			wants := map[expectKey][]*expectation{
				key: {
	...
	t.Run(
		"unexpected diagnostic when no expectations at position", func(t *testing.T) {
			t.Parallel()
			mt := &mockT{}
			wants := map[expectKey][]*expectation{}
	...
	t.Run(
		"no match when expectations exist but none match", func(t *testing.T) {
			t.Parallel()
			mt := &mockT{}
			wants := map[expectKey][]*expectation{
...
func TestReportUnmatched(t *testing.T) {
	...
	t.Run(
		"empty map produces no errors", func(t *testing.T) {
			t.Parallel()
			mt := &mockT{}
	...
	t.Run(
		"one key one expectation produces one error", func(t *testing.T) {
			t.Parallel()
			mt := &mockT{}
			wants := map[expectKey][]*expectation{
	...
	t.Run(
		"multiple keys and expectations produce matching error count", func(t *testing.T) {
			t.Parallel()
			mt := &mockT{}
			wants := map[expectKey][]*expectation{
				{file: "a.go", line: 1}: {
...
func TestCompareAllFixesGolden(t *testing.T) {
	...
	t.Run(
		"single fix matches expected", func(t *testing.T) {
			t.Parallel()
			mt := &mockT{}
			ffe := &fileEditsInfo{
				pkg: pkg,
	...
	t.Run(
		"single fix does not match expected", func(t *testing.T) {
			t.Parallel()
			mt := &mockT{}
			ffe := &fileEditsInfo{
				pkg: pkg,
	...
	t.Run(
		"conflicting edits", func(t *testing.T) {
			t.Parallel()
			mt := &mockT{}
			ffe := &fileEditsInfo{
				pkg: pkg,
	...
	t.Run(
		"multiple non-conflicting fixes merge successfully", func(t *testing.T) {
			t.Parallel()
			mt := &mockT{}
	...
	t.Run(
		"apply error with out-of-bounds edit", func(t *testing.T) {
			t.Parallel()
			mt := &mockT{}
			ffe := &fileEditsInfo{
				pkg: pkg,
...
func TestCompareArchiveGolden(t *testing.T) {
	...
	t.Run(
		"section matches fix and content matches", func(t *testing.T) {
			t.Parallel()
			mt := &mockT{}
			ffe := &fileEditsInfo{
				pkg: pkg,
	...
	t.Run(
		"section matches fix but content differs", func(t *testing.T) {
			t.Parallel()
			mt := &mockT{}
			ffe := &fileEditsInfo{
				pkg: pkg,
	...
	t.Run(
		"section name has no matching fix", func(t *testing.T) {
			t.Parallel()
			mt := &mockT{}
			ffe := &fileEditsInfo{
				pkg: pkg,
	...
	t.Run(
		"apply error with invalid edits", func(t *testing.T) {
			t.Parallel()
			mt := &mockT{}
			ffe := &fileEditsInfo{
				pkg: pkg,
